...
mes_escales_tour_du_monde[2]
        'qui renverra NYC qui est en position 3 Le premier élément dans un tableau a pour index 0 (et pas 1) ! 
        C est le cas aussi dans beaucoup de langages de programmation.'
        
mes_escales_tour_du_monde << "Londres"
        'Pour ajouter un élément dans un tableau, on utilise deux chevrons <<. Si je veux prolonger
        mon tour du monde à Londres, je taperai donc : '
...
mes_escales_tour_du_monde[6] = "Barcelone"
        ...
        Je peux donc remplacer Berlin par Barcelone si je parle mieux l espagnol que l allemand :'
